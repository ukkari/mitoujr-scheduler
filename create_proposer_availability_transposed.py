...
def create_proposer_availability_transposed(input_file, output_file, id_row_index=45):
    """
    ...
    Args:
        ...
        id_row_index: Row index (0-based) containing the proposer IDs
    """
...
def main():
    ...
    parser.add_argument('--id-row', type=int, default=None, help='Row index (0-based) containing the proposer IDs')
    ...
    availability_df = create_proposer_availability_transposed(args.input_file, args.output_file, args.id_row)
